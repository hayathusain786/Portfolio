export default function Footer (){
	...
	<div className="container flex flex-col p-4 mx-auto md:p-8 lg:flex-row divide-coolGray-400">
		...
		© {new Date().getFullYear()} <span className="text-[#FC4370] px-1">Hayat Husain.</span>
		</ul>
		<div className="flex flex-col justify-center pt-6 lg:pt-0">
			<div className="flex justify-center space-x-4">
				...
				<a href="https://github.com/hayathusain786" target="_blank" title="GitHub" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10  bg-[#EF404A]">
				...
				<a href="https://www.linkedin.com/in/hayat-husain-aa1046233" target="_blank" title="Linkedin" className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10  bg-[#EF404A]">
